...
Use [GitHub Security Advisories](https://github.com/meine-krankenkasse/typo3-search-algolia/security/advisories/new) to report vulnerabilities privately.
...
This policy covers the `typo3_search_algolia` TYPO3 extension code. For vulnerabilities in dependencies or TYPO3 core, please report to the respective upstream projects.
