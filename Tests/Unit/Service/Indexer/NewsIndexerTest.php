...
class NewsIndexerTest extends TestCase
{
    ...
    /**
     * Tests that getTable() returns the expected database table name 'tx_news_domain_model_news'.
     */
    #[Test]
    public function getTableReturnsTxNewsDomainModelNews(): void
    {
        self::assertSame('tx_news_domain_model_news', $this->subject->getTable());
    }
    ...
    /**
     * Creates a NewsIndexer with properly configured mocks for happy-path testing.
     */
    ...
    public function dequeueOneCallsRepositoryWithCorrectParameters(): void
    {
        ...
        $queueItemRepositoryMock
            ...
            ->with('tx_news_domain_model_news', [42], 7);
    ...
    public function dequeueMultipleCallsRepositoryWithCorrectParameters(): void
    {
        ...
        $queueItemRepositoryMock
            ->expects(self::once())
            ->method('deleteByTableAndRecordUIDs')
            ->with('tx_news_domain_model_news', [1, 2, 3], 7);
